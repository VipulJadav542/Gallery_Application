...
import com.rk.Gallery.Adapter.ImageFetchAdapter
import com.rk.Gallery.DataModel.Images
import com.rk.Gallery.databinding.ActivityImageUploadBinding
import com.rk.Gallery.databinding.DeletePhotoLayoutBinding
...
//                        val key = FirebaseDatabase.getInstance().getReference("Images").key
                        ...
                        binding.videoView.setImageResource(R.drawable.vector)
                    }
                }
            } else {
                binding.progressBar.visibility = View.INVISIBLE
                        ...
                        FirebaseDatabase.getInstance().getReference("Images")
                            ...
                            .removeValue().addOnCompleteListener { task ->
                                if (task.isSuccessful) {
                                    Toast.makeText(this@ImageUpload, "Deleted Successfully", Toast.LENGTH_SHORT).show()
                                } else {
